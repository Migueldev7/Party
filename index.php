...
<body>
    ...
    <audio autoplay controls>
        <source src="audio.mp3" controls type="audio/mp3" />
    </audio>
    ...
    <div class="container">
        ...
        <div class="row ">
            <div class="col-lg-7 mx-auto">
                <div class="card mx-auto py-0 bg-dark">
                    <div class="card-body pt-0 px-md-4 px-1 bg-dark">
                        <div class="container">
                            ...
                            <form id="contact-form" role="form" action="cadastro.php" method="post">
                                <div class="controls">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="form_need" name="bebida2" class="form-control" required="required" data-error="Please specify your need.">
                                                    ...
                                                    <option>Pepisi</option>
                                                    <option>tonica</option>
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="form_message">Quer um drink diferente?</label>
                                                <textarea id="form_message" name="recado" class="form-control" placeholder="Exemplo: Caipirinha de morango...." rows="4" required="required" data-error="Please, leave us a message."></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-column align-items-center my-4">
                                            ...
                                            <div class="col-md-6 text-center">
                                                <a href="https://nubank.com.br/pagar/opeum/PoeubkIv2q" target="_blank"><img src="codigo.jpg" alt=""></a>
                                            </div>
                                            <br>
                                            <div class="col-md-6 my-auto">
                                                <h5 class="text-center px-2 p-1">
                                                    Escanei ou clique no Qrcode
                                                    <!-- <span class="d-none d-md-inline">&#8594;</span>  -->
                                                    <span class="">&#8595;</span>
                                                </h5>
                                            </div>
